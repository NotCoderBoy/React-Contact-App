...
export default function Home() {
  ...
  return (
    <>
        ...
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              ...
              <h1 className="fw-bolder text-secondary">Contact Manager</h1>
      ...
      <section className="section section-lg bg-primary text-white" id="">
        <Container>
        ...
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              ...
              <div>
                <p>
                  We created a fully editable calendar where you can add, edit
                  and delete events for your admin dashboard.
                </p>
              </div>
            </Col>
          </Row>
        ...
        <Container>
          <Row>
            <Col md={4}>
              ...
              >
                <Image src={Logo} />
                <span className="ms-2 brand-text">Contact App</span>
              </Navbar.Brand>
              <p>
            ...
            <Col xs={6} md={2} className="mb-5 mb-lg-0">
              ...
              <ul className="links-vertical mt-2">
                <li>
                  <Card.Link as={Link} to={paths.LOGIN} target="_blank">
                    Getting started
                  </Card.Link>
                </li>
                <li>
            ...
            <Col xs={12} md={4} className="mb-2 mb-lg-0">
